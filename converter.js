...
function convert(input, num2eng=false) {
    console.log(typeof(num2eng));
    var unicode_output = kn_ascii2unicode(input)
    if(num2eng) {
...
function test() {
    var num2eng = true;
    var input = 'bÁAiÀiÁ¥ÀwUÀ¼ÀÄ';
    console.log(converter.convert(input, num2eng))
}
